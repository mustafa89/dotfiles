...
"let s:gb.dark0_hard  = ['#1B1C1C', 234]     " 29-32-33
"customer change below to make background pitch black
...
let s:gb.light1      = ['#ffffff', 223]     " 235-219-178
let s:gb.light2      = ['#ffffff', 250]     " 213-196-161
let s:gb.light3      = ['#ffffff', 248]     " 189-174-147
let s:gb.light4      = ['#ffffff', 246]     " 168-153-132
let s:gb.light4_256  = ['#ffffff', 246]     " 168-153-132



let s:gb.bright_red     = ['#fb4934', 167]     " 251-73-52
"let s:gb.bright_green   = ['#b8bb26', 142]     " 184-187-38
let s:gb.bright_green   = ['#e4e831', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#fabd2f', 214]     " 250-189-47
let s:gb.bright_blue    = ['#83a598', 109]     " 131-165-152
let s:gb.bright_purple  = ['#d3869b', 175]     " 211-134-155
"let s:gb.bright_aqua    = ['#8ec07c', 108]     " 142-192-124
let s:gb.bright_aqua    = ['#96e092', 108]     " 142-192-124
