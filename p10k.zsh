# Generated by Powerlevel10k configuration wizard on 2021-08-02 at 21:36 CEST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 40036.
# Wizard options: awesome-fontconfig, small icons, classic, unicode, darkest, 12h time,
# blurred heads, blurred tails, 2 lines, dotted, full frame, sparse, many icons, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=45
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=150
